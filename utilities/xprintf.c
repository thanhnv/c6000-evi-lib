 ...
 * @date May 19, 2013
 * @brief Using stdarg to parse input arguments, dump character out output device (UART/I2C) with a format (like printf,sprintf,...).
...
void xputs (					/* Put a string to the default device */
	const unsigned char* str				/* Pointer to the string */
)
{
	while (*str)
		xputc(*str++);
...
//static
void xvprintf (
	const unsigned char*	fmt,	/* Pointer to the format string */
