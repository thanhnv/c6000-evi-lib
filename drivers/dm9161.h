...
**************************************************************************/
extern unsigned int DM9161IDGet(unsigned int mdioBaseAddr,
                                  unsigned int phyAddr);
extern void DM9161Reset(unsigned int mdioBaseAddr,
                          unsigned int phyAddr);
extern unsigned int DM9161LoopBackEnable(unsigned int mdioBaseAddr,
                                           unsigned int phyAddr);
extern unsigned int DM9161LoopBackDisable(unsigned int mdioBaseAddr,
                                            unsigned int phyAddr);

extern unsigned int DM9161Configure(unsigned int mdioBaseAddr,
                                      unsigned int phyAddr,
                                      unsigned short speed,
                                      unsigned short dulplexMode);
extern unsigned int DM9161AutoNegotiate(unsigned int mdioBaseAddr,
                                          unsigned int phyAddr,
                                          unsigned short advVal);
extern unsigned int DM9161RegRead(unsigned int mdioBaseAddr,
                                   unsigned int phyAddr,
                                   unsigned int regIdx,
                                   unsigned short *regValAdr);
extern void DM9161RegWrite(unsigned int mdioBaseAddr,
                             unsigned int phyAddr,
                             unsigned int regIdx,
                             unsigned short regVal);

extern unsigned int DM9161PartnerAbilityGet(unsigned int mdioBaseAddr,
                                              unsigned int phyAddr,
