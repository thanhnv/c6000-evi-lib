...
extern void IntRegister (Uint32 cpuINT, void (*userISR)(void));
extern void IntUnRegister (Uint32 cpuINT);
extern void IntEventMap (Uint32 cpuINT, Uint32 sysINT);
extern void IntEventSet (Uint32 sysINT);
extern void IntEventClear(Uint32 sysINT);
extern void IntEventCombineInit(int ecmINT0, int ecmINT1, int ecmINT2, int ecmINT3);
extern void IntEventCombineAdd(Uint32 sysINT);
extern void IntEventCombineRemove(Uint32 sysINT);
extern void IntEventCombineRegister(Uint32 sysINT, void (*userISR)(void));
extern void IntEnable (Uint32 cpuINT);
extern void IntDisable (Uint32 cpuINT);
extern void IntReset (void);
extern void IntGlobalEnable (void);
extern Uint32 IntGlobalDisable (void);
extern void IntGlobalRestore (Uint32 restoreValue);
extern void ExcGlobalEnable (void);
extern void ExcCombineAdd(Uint32 sysINT);
extern void ExcCombineRemove(Uint32 sysINT);
