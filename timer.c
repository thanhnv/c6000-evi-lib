 ...
 *
 **/
void TimerEnable(Uint32 baseAddr, Uint32 timer,
                 Uint32 enaMode)
{
 ...
 *
 **/
void TimerDisable(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerConfigure(Uint32 baseAddr, Uint32 config)
{
 ...
 *
 **/
void TimerWatchdogActivate(Uint32 baseAddr)
{
 ...
 *
 **/
void TimerWatchdogReactivate(Uint32 baseAddr)
{
 ...
 *
 **/
void TimerPeriodSet(Uint32 baseAddr, Uint32 timer,
                    Uint32 period)
{
 ...
 *
 **/
Uint32 TimerPeriodGet(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerCounterSet(Uint32 baseAddr, Uint32 timer,
                     Uint32 counter)
{
    if(TMR_TIMER12 & timer)
    {
 ...
 *
 **/
Uint32 TimerCounterGet(Uint32 baseAddr, Uint32 timer)
{
    /* Return the appropriate period */
 ...
 *
 **/
void TimerReloadSet(Uint32 baseAddr, Uint32 timer,
                    Uint32 reload)
{
    if(TMR_TIMER12 & timer)
    {
 ...
 *
 **/
Uint32 TimerReloadGet(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
Uint32 TimerCaptureGet(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerCompareSet(Uint32 baseAddr, Uint32 regIndex,
                     Uint32 compare)
{
 ...
 *
 **/
Uint32 TimerCompareGet(Uint32 baseAddr, Uint32 regIndex)
{
 ...
 *
 **/
void TimerIntEnable(Uint32 baseAddr, Uint32 intFlags)
{
 ...
 *
 **/
void TimerIntDisable(Uint32 baseAddr, Uint32 intFlags)
{
 ...
 *
 **/
Uint32 TimerIntStatusGet(Uint32 baseAddr, Uint32 statFlag)
{
 ...
 *
 **/
Uint32 TimerIntStatusClear(Uint32 baseAddr, Uint32 statFlag)
{
 ...
 *
 **/
void TimerPreScalarCount34Set(Uint32 baseAddr, Uint32 psc34)
{
 ...
 *
 **/
Uint32 TimerPreScalarCount34Get(Uint32 baseAddr)
{
    /*
 ...
 *
 **/
void TimerDivDwnRatio34Set(Uint32 baseAddr, Uint32 tddr34)
{
 ...
 *
 **/
Uint32 TimerDivDwnRatio34Get(Uint32 baseAddr)
{
 ...
 *
 **/
void TimerCaptureConfigure(Uint32 baseAddr, Uint32 timer,
                           Uint32 cfgCap)
{
 ...
 *
 **/
void TimerReadResetEnable(Uint32 baseAddr, Uint32 timer)
{
    /*
 ...
 *
 **/
void TimerReadResetDisable(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerInputGateEnable(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerInputGateDisable(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerPulseWidthSet(Uint32 baseAddr, Uint32 timer,
                        Uint32 pulseWidth)
{
 ...
 *
 **/
void TimerClockModeSet(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerPulseModeSet(Uint32 baseAddr, Uint32 timer)
{
    /*
 ...
 *
 **/
Uint32 TimerOUTStatusGet(Uint32 baseAddr, Uint32 timer)
{
    /* Return the status */
 ...
 *
 **/
void TimerInvertINEnable(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerInvertINDisable(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerInvertOUTEnable(Uint32 baseAddr, Uint32 timer)
{
 ...
 *
 **/
void TimerInvertOUTDisable(Uint32 baseAddr, Uint32 timer)
{
